...
# AI ne cevapladı?
-AI da aynı şekilde koddaki if-else sorunu için Factory methodun diğerlerine göre daha uyumlu olduğu, builder ve abstractın şuanki koduma göre gereksiz karmaşık kalacacağını, singletonun ise kullanımının bulduğum problemi doğrudan çözemeyeceğini ekledi.
